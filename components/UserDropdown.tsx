  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button
          variant="ghost"
          className="flex items-center gap-3 bg-transparent px-0 md:px-1 text-zinc-300 hover:bg-transparent hover:text-zinc-100 focus-visible:ring-0"
        >
          ...
          <div className="hidden md:flex flex-col items-start">
            <span className="text-sm font-medium text-zinc-300 hover:text-teal-500">
              {user.name}
            </span>
          </div>
        </Button>
